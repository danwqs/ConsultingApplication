package com.example.navigationdraweractivity.ui.sobre;
...
public class SobreFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return new AboutPage(getActivity())
                ...
                .addFacebook("danwqs", "Facebook")
                .addTwitter("danwqs", "Twitter")
                .addYoutube("UC7dBSvC_RW_ku1Fr8C2ZPIQ", "Youtube")
                .addPlayStore("com.ideashower.readitlater.pro")
                .addGitHub("danwqs", "GitHub")
                .addInstagram("danrjr", "Instagram")
